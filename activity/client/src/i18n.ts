 ...
 * its own, so it can't call clashcontrol/i18n.py's t() directly — instead it fetches a flat
 ...
 * last-resort behavior (clashcontrol/i18n.py) so a missing string is visibly wrong rather than blank.
