...
See Cardinal Rule 10 (`.github/copilot-instructions.md`) and `../clashcontrol/docs/CODE_STRUCTURE.md`
...
update cycle from `main()` (`ClashControl.py`), after the `is_discord_available()` guard because it does
