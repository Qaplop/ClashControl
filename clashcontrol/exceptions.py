...
Usage:
    ...
    try:
        operation()
    except ClashControlError as e:
        logging.error(f"ClashControl operation failed: {e}")
...
class ClashControlError(Exception):
    """
    ...
    Example:
        try:
            ...
            logging.error(f"ClashControl error: {e}")
    """
...
class ConfigurationError(ClashControlError):
    """
...
class CacheError(ClashControlError):
    """
...
class WarProcessingError(ClashControlError):
    """
...
class LeaderboardError(ClashControlError):
    """
...
class AccountProtectionError(ClashControlError):
    """
...
class NotificationError(ClashControlError):
    """
...
class ValidationError(ClashControlError):
    """
