...
Example:
    python -m clashcontrol.move_old_archive_files
    python -m clashcontrol.move_old_archive_files --days 3 --dry-run
    python -m clashcontrol.move_old_archive_files --source "${PROD_DATA_DIR}/archive" --dest "${PROD_DATA_DIR}/archive_old"
"""
