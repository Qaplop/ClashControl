...
Data Sources:
1. Database: War history from clashcontrol.db (completed wars)
...
import glob
import fnmatch
# --- ensure project root on sys.path for 'clashcontrol' imports when running from scripts dir ---
import sys, pathlib
...
from clashcontrol.formatting import MODE_REGISTRY, DEFAULT_MODE, best_practice_player_cell, right_pad_number, text_display_width  # Use main project constants for leaderboard rendering

# Remove import from deprecated clashcontrol.stats.models
