...
Usage:
    python clashcontrol/scripts/check_translation_files.py
"""
...
class TranslationChecker:
    ...
    def __init__(self):
        ...
        self.en_path = self.project_root / "clashcontrol" / "translations" / "en.json"
        self.de_path = self.project_root / "clashcontrol" / "translations" / "de.json"
