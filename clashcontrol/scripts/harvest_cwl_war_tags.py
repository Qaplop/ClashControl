...
Output: clashcontrol/scripts/cwl_war_tags_2026-04.txt
Format (one line per war):
    <war_tag>\t<clan_tag>\t<opponent_tag>\t<round_number>\t<group_season>

Usage:
    python clashcontrol/scripts/harvest_cwl_war_tags.py [--season 2026-04] [--concurrency 30] [--dry-run]
...
def load_incomplete_clans(db_path: str, season: str, tracked_only: bool) -> list[str]:
    ...
    from clashcontrol.db_manager import attach_history_db, explicit_column_list_from_conn
