...
.github/copilot-instructions.md; full writeup in clashcontrol/docs/DATABASE_ARCHITECTURE.md's
...
Usage:
    python clashcontrol/scripts/repair_history_schema_drift.py                  # PREVIEW: read-only, writes nothing
    python clashcontrol/scripts/repair_history_schema_drift.py --build          # builds *_repaired for real, verifies
    python clashcontrol/scripts/repair_history_schema_drift.py --apply          # builds (if needed) + verifies + swaps
    python clashcontrol/scripts/repair_history_schema_drift.py --db ... --history-db ... --apply
    python clashcontrol/scripts/repair_history_schema_drift.py --build --batch-size 50000 --checkpoint-every-batches 10
    python clashcontrol/scripts/repair_history_schema_drift.py --sample-size 50 # more spot-check rows
"""
