...
`_sync_group_track_war_updates()` (clashcontrol/cache_manager.py) was hardened the
...
Usage:
    python -m clashcontrol.scripts.repromote_mid_season_clans --season 2026-08
    python -m clashcontrol.scripts.repromote_mid_season_clans --season 2026-08 --apply
