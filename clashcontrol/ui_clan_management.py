...
class ClanManagementView(discord.ui.View):
    ...
    async def _on_refresh(self, interaction: discord.Interaction) -> None:
        ...
        # Regenerate message
        from clashcontrol.QBdiscocmdshelper import format_clan_management_message, get_guild_clans_including_member_config
    ...
    async def _on_language_select(self, interaction: discord.Interaction) -> None:
        ...
        from clashcontrol.i18n import t, set_guild_language
        ...
        from clashcontrol.i18n import get_language_display_name
    ...
    async def _on_toggle_registration(self, interaction: discord.Interaction) -> None:
        ...
        try:
            from ClashControl import repost_playerregistration_messages
            import QBcore
    ...
    async def refresh_cwl_view(self, interaction: Optional[discord.Interaction], mode: str) -> None:
        ...
        (clashcontrol/ui_cwl_roster.py's _refresh_parent()) — same pattern as
    ...
    async def _on_select_language(self, interaction: discord.Interaction) -> None:
        ...
        from clashcontrol.i18n import get_guild_language
...
class LanguageConfigurationView(discord.ui.View):
    ...
    def _add_language_select(self):
        ...
        from clashcontrol.i18n import get_available_languages, get_language_display_name
    ...
    async def _on_language_select(self, interaction: discord.Interaction) -> None:
        ...
        from clashcontrol.i18n import set_guild_language
...
class ClanManagementLinkAccountView(discord.ui.View):
    ...
    async def _on_submit(self, interaction: discord.Interaction, admin_override: bool = False) -> None:
        ...
        from clashcontrol.QBdiscocmdshelper import complete_account_linking_flow, get_verified_player_owner, normalize_clan_tag, check_admin_permissions
        from clashcontrol.cache_manager import CACHE
        from clashcontrol.config import CONFIG
        import logging
...
class AdminOverrideConfirmView(discord.ui.View):
    ...
    async def _confirm_callback(self, interaction: discord.Interaction):
        """Confirm the admin override and proceed with linking."""
        from clashcontrol.QBdiscocmdshelper import process_player_registration
...
class ImportDataConfirmView(discord.ui.View):
    ...
    async def _confirm_callback(self, interaction: discord.Interaction):
        ...
        from clashcontrol.import_clashperk_userlist import apply_import_changes
        from clashcontrol.QBdiscocmdshelper import send_and_track
        from clashcontrol.cache_manager import CACHE
...
class SwitchViewContinueView(discord.ui.View):
    ...
    async def _continue_callback(self, interaction: discord.Interaction):
        ...
        from clashcontrol.import_clashperk_userlist import parse_clashperk_embed_with_tag_data
        from clashcontrol.QBdiscocmdshelper import send_and_track
        ...
        try:
            ...
            from clashcontrol.import_clashperk_userlist import analyze_import_changes
