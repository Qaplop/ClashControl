...
from clashcontrol.ui_common import TrackedView
...
class UnifiedNotificationView(TrackedView):
    ...
    async def toggle_notifications(self, interaction: discord.Interaction):
        ...
        from clashcontrol.QBdiscocmdshelper import update_notification_subscription
        from clashcontrol.cache_manager import CACHE
        import logging
...
class LanguageSelectionView(TrackedView):
    ...
    def __init__(self, user_id: str, parent_view: UnifiedNotificationView, original_interaction: Optional[discord.Interaction], timeout: int = 180):
        ...
        from clashcontrol.i18n import t, get_available_languages
...
class LinkBuddyModal(discord.ui.Modal, title="Link Buddy Account"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        from clashcontrol.QBdiscocmdshelper import get_guild_clans_including_member_config, get_player_list, normalize_clan_tag
