...
from clashcontrol.i18n import t  # type: ignore[reportUnusedImport]  # tests monkeypatch ui_registration.t
from clashcontrol.cache_manager import CACHE
from clashcontrol.ui_common import GenericSelectView, TrackedView, update_user_metadata_from_interaction
from clashcontrol.ui_common import claim_action, lock_buttons
from clashcontrol.ui_notifications import WarNotificationPromptView
...
async def _clan_filter_callback(
    ...
    """
    from clashcontrol.QBdiscocmdshelper import get_player_list
...
async def _show_player_search_modal(interaction: discord.Interaction, guild_id: int, user_mentioned: bool = False, action_view_interaction: Optional[discord.Interaction] = None):
    ...
    from clashcontrol.QBdiscocmdshelper import get_player_list, get_guild_clans_including_member_config
    from clashcontrol.i18n import t
...
class RegistrationView(TrackedView):
    ...
    def _resolve_guild_id(self, interaction: discord.Interaction) -> int:
        ...
        if pending is not None:
            return pending
        from clashcontrol.QBdiscocmdshelper import get_dm_registration_guild_ids
...
class VerifyAccountModal(discord.ui.Modal, title="Verify Account"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        from clashcontrol.QBdiscocmdshelper import verify_and_update_player
        from clashcontrol.i18n import t
        ...
        if verified:
            ...
            if (role_guild := _role_guild(interaction)) is not None:
                from clashcontrol.QBdiscocmdshelper import assign_member_role
            ...
            if self.parent_view and self.parent_view.original_interaction:
                ...
                from clashcontrol.QBdiscocmdshelper import check_and_prompt_war_notifications
                from clashcontrol.i18n import t
                guild_id = interaction.guild.id if interaction.guild else None
...
class ApiTokenEntryModal(discord.ui.Modal, title="Enter API Token"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        from clashcontrol.QBdiscocmdshelper import verify_and_update_player, check_and_prompt_war_notifications
        from clashcontrol.cache_manager import CACHE
        from clashcontrol.i18n import t
        import logging
...
class PlayerSubstringModal(discord.ui.Modal, title="Enter Player Data"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        from clashcontrol.QBdiscocmdshelper import process_player_registration, normalize_clan_tag
        from clashcontrol.cache_manager import CACHE
        ...
        if not matches:
            from clashcontrol.QBdiscocmdshelper import complete_account_linking_flow, normalize_clan_tag
            from clashcontrol.cache_manager import CACHE
