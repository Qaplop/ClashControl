...
# ---------------------------------------------------------------------------
# /whois player's name-search branch (_whois_slash_logic) — integration-level behavior
# ---------------------------------------------------------------------------
...
class TestWhoisSlashTwoStepSearch:
    ...
    async def test_short_query_no_guild_match_sends_too_short(self, mock_interaction, monkeypatch, _no_guild_clans):
        ...
        await QBdiscordcmds.whois_player.callback(mock_interaction, player="Al")  # type: ignore[arg-type]
    ...
    async def test_three_char_query_runs_global_fallback(self, mock_interaction, monkeypatch, _no_guild_clans):
        ...
        await QBdiscordcmds.whois_player.callback(mock_interaction, player="Ali")  # type: ignore[arg-type]
    ...
    async def test_guild_match_never_truncated_by_global_hard_cap(self, mock_interaction, monkeypatch):
        ...
        await QBdiscordcmds.whois_player.callback(mock_interaction, player="alphabet")  # type: ignore[arg-type]
