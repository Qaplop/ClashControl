...
class TestGetModeAutocompleteChoices:
    ...
    async def test_all_modes_returned(self):
        from clashcontrol.QBdiscocmdshelper import get_mode_autocomplete_choices

        with patch("clashcontrol.QBdiscocmdshelper.CACHE") as mock_cache:
    ...
    async def test_filter_by_current(self):
        ...
        with patch("clashcontrol.QBdiscocmdshelper.CACHE"):
    ...
    async def test_subscribed_modes_only(self):
        ...
        with patch("clashcontrol.cache_manager.CACHE") as mock_cache:
...
class TestDeleteMessagesByFilter:
    ...
    async def test_channel_not_found(self):
        from clashcontrol.QBdiscocmdshelper import _delete_messages_by_filter
    ...
    async def test_deletes_matching_messages(self):
        ...
        with patch("clashcontrol.QBdiscocmdshelper.CACHE") as mock_cache, \
             patch("QBcore.bot") as mock_bot, \
             patch("clashcontrol.QBdiscocmdshelper.discord_retry", new_callable=AsyncMock):
