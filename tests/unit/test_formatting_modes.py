...
class TestApplyCwlModeSuffix:
    ...
    def test_no_cwl_suffix_modes_unchanged_when_cwl_only(self, mode):
        from clashcontrol.formatting import apply_cwl_mode_suffix
    ...
    def test_all_no_cwl_suffix_modes_exist_in_registry_without_variant(self):
        ...
        from clashcontrol.formatting import MODE_REGISTRY, NO_CWL_SUFFIX_MODES
...
class TestBestPracticePlayerCell:
    ...
    def test_ascii_name_exact_width(self) -> None:
        from clashcontrol.formatting import best_practice_player_cell, text_display_width_float
    ...
    def test_long_name_truncated_to_target(self) -> None:
        from clashcontrol.formatting import best_practice_player_cell, text_display_width
...
class TestTruncateToWidthExtended:
    ...
    def test_short_string_unchanged(self) -> None:
        from clashcontrol.formatting import truncate_to_width
...
class TestFindOptimalSpaceCombination:
    ...
    def test_tiny_gap_returns_unchanged(self) -> None:
        from clashcontrol.formatting import _find_optimal_space_combination, text_display_width_float
...
class TestRenderLeaderboardHighlight:
    ...
    def test_highlighted_row_wrapped_in_ansi_codes(self) -> None:
        from clashcontrol.formatting import render_leaderboard, _ANSI_HIGHLIGHT, _ANSI_RESET
    ...
    def test_no_highlight_set_means_no_ansi_codes(self) -> None:
        from clashcontrol.formatting import render_leaderboard, _ANSI_HIGHLIGHT
